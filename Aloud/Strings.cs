    ...
    public class Strings : INotifyPropertyChanged
    {
        ...
        private Dictionary<string, Dictionary<string, string>> _dict = new Dictionary<string, Dictionary<string, string>>()
        {
            { "es", new Dictionary<string, string>() {
                ...
                { "BtnAttachPhoto", "+ Adjuntar fotos y/o videos" },
                { "FeedbackPlaceholder", "Escriba aquí..." },
                { "BtnFeedbackSending", "Enviando..." },
                { "BtnFeedbackSent", "¡Feedback enviado! Gracias" },
                { "LblNoPhoto", "Ninguna foto seleccionada" },
                { "BtnSendFeedbackAction", "Enviar" },
            ...
            { "en", new Dictionary<string, string>() {
                ...
                { "BtnSendFeedbackAction", "Send" },
                { "LblNoPhoto", "No photo selected" },
                { "BtnAttachPhoto", "+ Attach photos and/or videos" },
                { "FeedbackPlaceholder", "Type here..." },
                { "BtnFeedbackSending", "Sending..." },
                { "BtnFeedbackSent", "Feedback sent! Thanks" },
        ...
        public string MenuFeedback => Get("MenuFeedback");
        ...
        public string FeedbackPlaceholder => Get("FeedbackPlaceholder");
        public string BtnFeedbackSending => Get("BtnFeedbackSending");
        public string BtnFeedbackSent => Get("BtnFeedbackSent");
