...
namespace LectorGlobalApp
{
    public partial class MainWindow : Window
    {
        ...
        private async void HandleHotkey(int id)
        {
            ...
            try
            {
                ...
                else if (id == 4) // Dictation
                {
                    ...
                    await Task.Delay(600); // Wait for final transcription
        ...
        private void BtnCargarFoto_Click(object sender, RoutedEventArgs e)
        {
            ...
            openFileDialog.Filter = "Imágenes (*.png;*.jpeg;*.jpg)|*.png;*.jpeg;*.jpg|Todos (*.*)|*.*";
            openFileDialog.Multiselect = true;
            if (openFileDialog.ShowDialog() == true)
            {
                foreach(string file in openFileDialog.FileNames) {
                    if (selectedImagePaths.Count < 10 && !selectedImagePaths.Contains(file)) {
        ...
        private async void BtnEnviarFeedbackAction_Click(object sender, RoutedEventArgs e)
        {
            ...
            BtnEnviarFeedbackAction.Content = "Enviando...";
            ...
            try 
            {
                ...
                TxtFeedbackStatus.Text = "¡Feedback enviado con éxito!";
                TxtFeedbackStatus.Visibility = Visibility.Visible;
                
                await Task.Delay(3000);
                TxtFeedbackStatus.Visibility = Visibility.Collapsed;
            }
            catch (Exception ex)
            {
            ...
            finally
            {
                ...
                BtnEnviarFeedbackAction.Content = "Enviar Feedback";
            }
        }
        ...
        private int hkD_Mod = MOD_CTRL | MOD_WIN; private int hkD_Key = (int)System.Windows.Forms.Keys.A;
        private int hkS_Mod = MOD_CTRL | MOD_WIN; private int hkS_Key = (int)System.Windows.Forms.Keys.S;
        ...
        private void BtnResetHotkeys_Click(object sender, RoutedEventArgs e)
        {
            ...
            hkD_Mod = MOD_CTRL | MOD_WIN; hkD_Key = (int)System.Windows.Forms.Keys.A;
            hkS_Mod = MOD_CTRL | MOD_WIN; hkS_Key = (int)System.Windows.Forms.Keys.S;
            UpdateHotkeysText();
            SaveHotkeys();
        }
